...
var react_9 = react.useContext;
var react_10 = react.useReducer;
var react_11 = react.useRef;
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' && typeof window.document !== 'undefined' && typeof window.document.createElement !== 'undefined' ? react_6 : react_7;
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var usePureOnlyMemo = pure ? react_8 : function (callback) {
      return callback();
    };

    function ConnectFunction(props) {
      var _useMemo = react_8(function () {
      ...
      var ContextToUse = react_8(function () {
      ...
      var contextValue = react_9(ContextToUse); // The store _must_ exist as either a prop or in context
      ...
      var childPropsSelector = react_8(function () {
        // The child props selector needs the store reference as an input.
        // Re-create this selector whenever the store changes.
        return createChildSelector(store);
      }, [store]);

      var _useMemo2 = react_8(function () {
      ...
      var overriddenContextValue = react_8(function () {
      ...
      var _useReducer = react_10(storeStateUpdatesReducer, EMPTY_ARRAY, initStateUpdates),
      ...
      var lastChildProps = react_11();
      var lastWrapperProps = react_11(wrapperProps);
      var childPropsFromStoreUpdate = react_11();
      var renderIsScheduled = react_11(false);
      ...
      var renderedWrappedComponent = react_8(function () {
      ...
      var renderedChild = react_8(function () {
...
var ADD_BOTTLE = 'ADD_BOTTLE';
var SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER';
var SHOW_ALL = 'SHOW_ALL';
var SHOW_RED = 'SHOW_RED';
var SHOW_WHITE = 'SHOW_WHITE';
var SHOW_OTHER = 'SHOW_OTHER';
var SET_UI_MODE = 'SET_UI_MODE';
var LIST = 'LIST';
var EDIT = 'EDIT';
var DETAIL = 'DETAIL';
...
var bottle = function bottle(state, action) {
  switch (action.type) {
    case ADD_BOTTLE:
      return {
        id: action.id,
...
var bottles = function bottles() {
  ...
  switch (action.type) {
    case ADD_BOTTLE:
      return [].concat(_toConsumableArray(state), [bottle(undefined, action)]);
...
var addBottle = function addBottle(id, name, colour, detail) {
  return {
    type: ADD_BOTTLE,
    id: id,
    name: name,
...
var setUiMode = function setUiMode(mode, id) {
  return {
    type: SET_UI_MODE,
    mode: mode
  };
...
var AddBottleWrapped = function AddBottleWrapped(_ref) {
  var dispatch = _ref.dispatch;
  var input$name;
  var select$color;
  var textarea$detail;
  return react.createElement("div", {
    className: "uk-card uk-card-default uk-width-xlarge"
  }, react.createElement("div", {
    className: "uk-card-header"
  }, "Please enter the details of your wine"), react.createElement("div", {
  ...
  }), " ", react.createElement("br", null), " ", react.createElement("br", null), "Colour: ", react.createElement("select", {
    ref: function ref(node) {
      select$color = node;
    },
    className: "uk-select"
    ...
    value: OTHER
  }, "other")), react.createElement("br", null), react.createElement("br", null), react.createElement("textarea", {
    className: "uk-textarea",
    rows: "5",
    placeholder: "Details",
    ref: function ref(node) {
      textarea$detail = node;
    }
  })), react.createElement("div", {
    ...
    onClick: function onClick() {
      dispatch(addBottle(v4_1(), input$name.value, select$color.value, textarea$detail.value));
      input$name.value = '';
      select$color.value = '';
...
var AddBottle = connect()(AddBottleWrapped);
...
var Footer = function Footer() {
  return react.createElement("p", null, "Show:", ' ', react.createElement(FilterLink, {
    ...
    filter: SHOW_RED
  }, "RED"), ' ', react.createElement(FilterLink, {
    filter: SHOW_WHITE
  }, "WHITE"), ' ', react.createElement(FilterLink, {
    filter: SHOW_OTHER
  }, "OTHER"));
};
...
var getVisibleBottles = function getVisibleBottles(bottles, filter) {
  switch (filter) {
    case SHOW_ALL:
      return bottles;
    ...
    case SHOW_WHITE:
      return bottles.filter(function (b) {
        return b.colour === WHITE;
      });

    case SHOW_OTHER:
      return bottles.filter(function (b) {
        return !(b.colour === RED || b.colour === WHITE);
      });
  }
};
/**
...
var Bottle = function Bottle(_ref) {
...
var BottleList = function BottleList(_ref2) {
  var bottles = _ref2.bottles,
      onBottleClick = _ref2.onBottleClick;
  return react.createElement("div", {
    className: "uk-card uk-card-default uk-width-xlarge"
  }, react.createElement("div", {
    className: "uk-card-header"
  }, "Click the bottle to see details"), react.createElement("div", {
    className: "uk-card-body"
  }, react.createElement("ul", null, bottles.map(function (bottle) {
    return react.createElement(Bottle, _extends$1({
      key: bottle.id
    }, bottle, {
      onClick: function onClick() {
        return onBottleClick(bottle.id);
      }
    }));
  }))), react.createElement("div", {
    className: "uk-card-footer"
...
var mapDispatchToProps$1 = function mapDispatchToProps(dispatch) {
  return {
    onBottleClick: function onBottleClick(id) {
      dispatch(setUiMode(DETAIL));
      dispatch(showDetail(id));
    }
  };
};

var VisibleBottlesList = connect(mapStateToProps$1, mapDispatchToProps$1)(BottleList);

var mapStateToProps$2 = function mapStateToProps(state) {
  return {
    record: state.bottles.filter(function (b) {
      return b.id === state.detail;
    })[0] // there should be only one

  };
};

var DetailsWrapped = function DetailsWrapped(_ref) {
  var record = _ref.record;
  return react.createElement("div", {
    className: "uk-card uk-card-default uk-width-xlarge"
  }, react.createElement("div", {
    className: "uk-card-header"
  }, record.name), react.createElement("div", {
    className: "uk-card-body"
  }, react.createElement("p", null, record.detail)), react.createElement("div", {
    className: "uk-card-footer"
...
var Details = connect(mapStateToProps$2)(DetailsWrapped);
...
var TabLink = connect(mapStateToProps$3, mapDispatchToProps$2)(Link$1);
...
var TabBar = function TabBar() {
  return react.createElement("nav", {
    ...
    mode: LIST
  }, "ALL WINES"), react.createElement(TabLink, {
    mode: EDIT
  }, "ADD NEW")));
};

var CellarAppWrapped = function CellarAppWrapped(_ref) {
  var uimode = _ref.uimode;
  return react.createElement("div", null, react.createElement(TabBar, null), uimode == LIST ? react.createElement(VisibleBottlesList, null) : null, uimode == EDIT ? react.createElement(AddBottle, null) : null, uimode == DETAIL ? react.createElement(Details, null) : null);
};
...
var CellarApp = connect(mapStateToProps$4)(CellarAppWrapped);
...
var store = createStore(cellar, data);
reactDom.render(react.createElement(Provider, {
  store: store
}, react.createElement(CellarApp, null)), document.getElementById('root'));
